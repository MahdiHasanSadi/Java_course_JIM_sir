...
public class E0 extends JFrame{
...
// 			  new Admission2_Page();
        ...
        ImageIcon icon = new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\g.png");
        T1_Label = new JLabel(icon,JLabel.LEFT);
        T1_Label.setBounds(40,80,140,140);//52,30,80,32
        input_Panel.add(T1_Label);

        principal1_Txt = new JTextField("Name: Nujhat Rahman",JTextField.LEFT); 
        ...
        principal2_Txt = new JTextField("Position: Accounts Officer");
        ...
        principal3_Txt = new JTextField("Contact: +88 01517-777799");
        ...
        principal4_Txt = new JTextField("accoffi1@abcschool.com");
