...
public class Student_Register_2_Page extends JFrame{
	
	JPanel title_Panel,input_Panel;
	JTextField name_Txt,email_Txt,ID_Txt,password_Txt,conPass_Txt;
	JLabel title_Label,name_Label,ID_Label,email_Label,password_Label,conPass_Label,login_Label,signUp_Label,imgTxt_Label;
	JButton login_Btn,reg_Btn,min_Btn,close_Btn,back_Btn,back_Btn1;
	
	public Student_Register_2_Page() {
		setSize(500,400);
		setUndecorated(true);
		setResizable(false);
...
//        Font newButtonFont = new Font(login_Btn.getFont().getName(),Font.ITALIC+Font.BOLD,login_Btn.getFont().getSize());
...
//        back_Btn1.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        signUp_Label.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\s.png"));
        ...
        login_Btn.setFont(font9);//218, 258, 48, 20
        ...
        reg_Btn.addActionListener(new ActionListener(){
	    	...
	    	////*******************************************************************************
	    	   ...
	    	   {
	    		   String insertQuery = "INSERT INTO `student_register`(`ID`, `Name`, `Email`, `Password`) VALUES ('"+ID+"','"+Name+"','"+Email+"','"+Password+"')";
