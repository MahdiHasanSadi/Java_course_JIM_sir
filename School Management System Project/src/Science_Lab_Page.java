...
public class Science_Lab_Page extends JFrame{
...
//        Science_Lab_Label = new JLabel();
//        Science_Lab_Label.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\2.png"));
//        Science_Lab_Label.setBounds(0,0,500,300);//52,30,80,32
//        input_Panel.add(Science_Lab_Label);
        
        Science_Lab_Label1 = new JLabel("Science Lab",JLabel.CENTER);
        Science_Lab_Label1.setFont(font5);
        Science_Lab_Label1.setForeground(new Color(255,255,255));
        Science_Lab_Label1.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\l11.png"));
        Science_Lab_Label1.setBounds(0,5,500,35);//52,30,80,32
        input_Panel.add(Science_Lab_Label1);
        
        JTextArea txt = new JTextArea("ABC has a well equipped modern science lab with three sections\n"
        		                    + "of physics,chemistry and biology.\n"
        		                    + "\n"
        		                    + "This science lab equipments allow students to get practical allow\n"
        		                    + "students to get practical experience of what they learn in the\n"
        		                    + "class room.Students get firsthand learning experience by\n"
        		                    + "performing various experiments on their own.They feel very much \n"
        		                    + "interested in working in the lab, because they can understand \n"
        		                    + "different science theories and concepts by working there.\n");
        txt.setBounds(28,60,442,200);
