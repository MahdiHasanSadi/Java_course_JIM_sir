...
public class Login_Page extends JFrame{
	...
	JButton back_Btn1,teacherLogin_Btn,studentLogin_Btn,reg_Btn,min_Btn,close_Btn,back_Btn,here_Btn;
...
// 			  new Admission2_Page();
        ...
        signIn_Label.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\l.png"));
        signIn_Label.setBounds(0,30,500,40);//52,30,80,32
        
        
        //..........................Teacher's login Button..................................//
       
        teacherLogin_Btn = new JButton("Teacher's Login"); 
        teacherLogin_Btn.setBounds(150, 110, 200, 40);//335, 163, 110, 40//190, 163, 110, 40
        teacherLogin_Btn.setFont(font4);
        teacherLogin_Btn.setBorder(emptyBorder);
        //teacherLogin_Btn.setBackground(new Color(135,206,250));
        teacherLogin_Btn.addActionListener(new ActionListener() {
        	@Override
            public void actionPerformed(ActionEvent e) {
                dispose();
        ...
        //..........................Student's login Button..................................//
        
        studentLogin_Btn = new JButton("Student's Login"); 
        studentLogin_Btn.setBounds(150, 180, 200, 40);//335, 163, 110, 40//190, 163, 110, 40
        studentLogin_Btn.setFont(font4);
        studentLogin_Btn.setBorder(emptyBorder);
        //studentLogin_Btn.setBackground(new Color(135,206,250));
        studentLogin_Btn.addActionListener(new ActionListener() {
        	@Override
            public void actionPerformed(ActionEvent e) {
                dispose();
				new Student_Login_1_Page();
            }
        });
        
        //..........................Here Button..................................//
        
        login_Label = new JLabel("Don't Have an Account?Click",JLabel.CENTER);
        login_Label.setBounds(130, 250, 200, 30);
        login_Label.setFont(font3);
        
        here_Btn = new JButton("Here"); 
        here_Btn.setBounds(315, 253, 48, 20);//335, 163, 110, 40//190, 163, 110, 40
        ...
        add(input_Panel);
        input_Panel.add(teacherLogin_Btn);
        input_Panel.add(studentLogin_Btn); 
