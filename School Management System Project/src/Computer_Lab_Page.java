...
public class Computer_Lab_Page extends JFrame{
...
// 			  new Admission2_Page();
        ...
        Science_Lab_Label1 = new JLabel("Computer Lab",JLabel.CENTER); 
        Science_Lab_Label1.setFont(font5);
        Science_Lab_Label1.setForeground(new Color(255,255,255));
        Science_Lab_Label1.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\computer.png"));
        ...
        JTextArea txt = new JTextArea("Everyone lives in a society dependent on technology.Computers\n"
        		                    + "are significant to education because they make students to think\n"
        		                    + "what to learn and how learn useful information. Classroom with\n"
        		                    + "computers have become an important part of the curriculum and\n"
        		                    + "need to be used daily.Putting computers right in front of students\n"
        		                    + "is a priority in almost all school. They help students gather\n"
        		                    + "information related to the subjects they study. These also help\n"
        		                    + "them learn complex operation of these sophisticated gadgets with\n"
        		                    + "future preparation, and benefits learning among students and\n"
        		                    + "teachers.\n"
        		                    + "ABC international school establish international standard\n"
        		                    + "computer laboratory with 8th generation computer,a ergonomic\n"
        		                    + "furniture and power backup.");
        txt.setBounds(28,38,442,220);
