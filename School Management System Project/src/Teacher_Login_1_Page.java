...
public class Teacher_Login_1_Page extends JFrame{
	...
	JButton back_Btn1,login_Btn,reg_Btn,min_Btn,close_Btn,back_Btn;
	
	public Teacher_Login_1_Page() {
		setSize(500,400);
		setUndecorated(true);
		setResizable(false);
...
//        back_Btn1.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        signIn_Label.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\t.png"));
        ...
        reg_Btn.addActionListener(new ActionListener(){
 	       ...
 	       public void actionPerformed(ActionEvent e)
 	       {
 	    	  ...
 	    	  String queryLogin = "SELECT * FROM `teacher_register`";
 	    	  db.T_Login(queryLogin,Email,Password);
