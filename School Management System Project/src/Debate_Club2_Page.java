...
public class Debate_Club2_Page extends JFrame{
...
// 			  new Admission2_Page();
        ...
        JTextArea txt = new JTextArea("⦿ Internal activities of the school debate:\r\n"
        		                    + "\r\n"
        		                    + "    • Inter-class school competition for (class iii- v)\n"
