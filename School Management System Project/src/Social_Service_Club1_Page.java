...
public class Social_Service_Club1_Page extends JFrame{
	...
	public Social_Service_Club1_Page() {
		setSize(500,400);
		setUndecorated(true);
		setResizable(false);
...
//        back_Btn1.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        JTextArea txt = new JTextArea("The Social Work Club is a diverse group committed to providing\n"
        		                    + "programming and activities that promote professional growth,\n"
        		                    + "community service and camaraderie among its members.\r\n"
        		                    + "\n"
        		                    + "Students in the Social Work major or any other major, faculty, and\n"
        		                    + "staff members are encouraged to be active in the Social Work\n"
        		                    + "Club.The faculty advisor is Sakur Majid, Assistant Teacher.The\n"
        		                    + "Club functions as an advisory group to the Department of Social \n"
        		                    + "Work coordinator.");
