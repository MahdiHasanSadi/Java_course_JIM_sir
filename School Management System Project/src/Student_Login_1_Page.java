...
public class Student_Login_1_Page extends JFrame{
	...
	public Student_Login_1_Page() {
        ...
        Font font9 = new Font("Arial",Font.ITALIC+Font.BOLD,20);
...
//        back_Btn1.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        login_Btn = new JButton("Here"); //315, 253, 48, 20
        login_Btn.setBounds(237, 227, 48, 20);//335, 163, 110, 40//190, 163, 110, 40//237, 223, 50, 30
