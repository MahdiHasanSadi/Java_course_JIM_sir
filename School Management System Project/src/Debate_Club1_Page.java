...
public class Debate_Club1_Page extends JFrame{
...
//        back_Btn1.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        Science_Lab_Label1 = new JLabel("Debate Club",JLabel.CENTER); 
        Science_Lab_Label1.setFont(font5);
        Science_Lab_Label1.setForeground(new Color(255,255,255));
        Science_Lab_Label1.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\debate.png"));
        ...
        JTextArea txt = new JTextArea("Debate is an art. It sharpens the rational thoughts and logic of\n"
        		                    + "human beings.Various aspects of our life are affected by debate.\n"
        		                    + "ABC School always emphasizes on the importance of debate for\n"
        		                    + "the total formation of the students.If we study the history of ABC\n"
        		                    + "School debate,we find that it was introduced by the students of\n"
        		                    + "class 7 during the time of the Headmaster,…………….From then\n"
        		                    + "various formal debate activities are being organized regularly by\n"
        		                    + "this club.Presently the moderator of is Hasan Ahmad,Assistant\n"
        		                    + "teacher of our school.He is running this club effectively with other\n"
        		                    + "teachers and students from the very beginning of his position.\n"
        		                    + "The dedicated practice of the members of GDC has enlightened\n"
        		                    + "the students and put them at the zenith of success.\n");
        ...
        next_Btn.setBounds(420,263,50,25);//335, 163, 110, 40//190, 163, 110, 40
