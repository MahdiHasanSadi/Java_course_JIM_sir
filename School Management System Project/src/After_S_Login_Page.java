...
public class After_S_Login_Page extends JFrame{
	JPanel title_Panel,input_Panel;
	JTextField email_Txt,pass_Txt;
	JLabel title_Label,aboutUs_Label;
	JButton next,Routine,Result,back_Btn1,student_Activity_Btn,academic_Council_Btn,administration_Btn,principal_Msg_Btn,min_Btn,close_Btn,back_Btn,back_To_Home_Btn;
	
	public After_S_Login_Page() { 
		setSize(500,400);
		setUndecorated(true);
		setResizable(false);
...
// 			  new Admission2_Page();
        ...
        aboutUs_Label = new JLabel("Student",JLabel.CENTER);
...
//        Result.setForeground(new Color(255,255,255));
        Result.setBounds(175,90,150,40);//52,30,80,32
...
//        Routine.setForeground(new Color(255,255,255));
        Routine.setBounds(175,160,150,40);//52,30,80,32
...
//        next.setForeground(new Color(255,255,255));
        next.setBounds(375,245,150,40);//52,30,80,32
