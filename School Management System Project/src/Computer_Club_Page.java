...
public class Computer_Club_Page extends JFrame{
...
// 			  new Computer_Club2_Page();
        ...
        Science_Lab_Label1.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\Cclub.png"));
        Science_Lab_Label1.setBounds(0,8,500,35);//52,30,80,32
        ...
        JTextArea txt = new JTextArea("ABC School is very fortunate to have 2 state-of-the-art computer\n"
        		                    + "suites - one of these centres on Windows technologies,while the \n"
        		                    + "newest of our suites is geared towards Apple technologies,\n"
        		                    + "including iPads.\n"
        		                    + "\n"
        		                    + "The club is taken by the school's ICT coordinator, Mrs Sultana\n"
        		                    + "Begum and this year the focus has been on Coding. The children\n"
        		                    + "in year 5 have also been busy with Code Club. The projects are\n"
        		                    + "easy to follow with step-by-step guides which help young people\n"
        		                    + "learn Scratch, HTML & CSS, and Python by making games,\n"
        		                    + "animations,and websites.A team of volunteers share their\n"
        		                    + "knowledge with the kids.");
        txt.setBounds(28,45,442,220);
