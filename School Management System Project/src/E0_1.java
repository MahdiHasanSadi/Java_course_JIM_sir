...
public class E0_1 extends JFrame{
...
// 			  new Admission2_Page();
        ...
        principal1_Txt = new JTextField("Name: Md Rahim Uddin",JTextField.LEFT); 
        ...
        principal3_Txt = new JTextField("Contact: +88 01817-788777");
        ...
        principal4_Txt = new JTextField("accofficer1@abcschool.com");
