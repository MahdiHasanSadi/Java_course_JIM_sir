...
public class Lab_Page extends JFrame{
	...
	public Lab_Page() {
        ...
        Font font6 = new Font("Arial",Font.BOLD+Font.ITALIC,20);
...
// 			  new Admission2_Page();
        ...
        faculty_Label = new JLabel("Lab",JLabel.CENTER);
        faculty_Label.setFont(font5);
        faculty_Label.setForeground(new Color(255,255,255));
        faculty_Label.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\l10.png"));
        faculty_Label.setBounds(0,10,500,50);//52,30,80,32
        input_Panel.add(faculty_Label);
       
        employee1_Button = new JButton("Science Lab"); 
        employee1_Button.setBounds(150, 90, 200, 40);//335, 163, 110, 40//190, 163, 110, 40
        ...
        employee2_Button.setBounds(150, 165, 200, 40);//335, 163, 110, 40//190, 163, 110, 40
