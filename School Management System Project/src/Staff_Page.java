...
public class Staff_Page extends JFrame{
	...
	JButton back_Btn1,teacherLogin_Btn,employeeLogin_Btn,reg_Btn,min_Btn,close_Btn,back_Btn,here_Btn;
...
// 			  new Admission2_Page();
        ...
        signIn_Label = new JLabel("Staff",JLabel.CENTER);
        signIn_Label.setFont(font5);
        signIn_Label.setForeground(new Color(255,255,255));
        signIn_Label.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\st.png"));
        signIn_Label.setBounds(0,30,500,40);//52,30,80,32
        
        
        //..........................Teacher's login Button..................................//
       
        teacherLogin_Btn = new JButton("Teacher"); 
        ...
        //..........................employee's login Button..................................//
        
        employeeLogin_Btn = new JButton("Employee"); 
        employeeLogin_Btn.setBounds(150, 180, 200, 40);//335, 163, 110, 40//190, 163, 110, 40
        employeeLogin_Btn.setFont(font4);
        employeeLogin_Btn.setBorder(emptyBorder);
        //employeeLogin_Btn.setBackground(new Color(135,206,250));
        employeeLogin_Btn.addActionListener(new ActionListener() {
        	@Override
            public void actionPerformed(ActionEvent e) {
                dispose();
				new Employee0_Page();
        ...
        input_Panel.add(employeeLogin_Btn); 
