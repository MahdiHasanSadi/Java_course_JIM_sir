...
public class Teacher_Register_2_Page extends JFrame{
	...
	public Teacher_Register_2_Page() {
		setSize(500,400);
		setUndecorated(true);
		setResizable(false);
        ...
        Font font10 = new Font("Arial",Font.ITALIC+Font.BOLD,20);//218, 258, 48, 20
...
//        back_Btn1.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        reg_Btn.addActionListener(new ActionListener(){
	    	...
	    	////*******************************************************************************
	    	   ...
	    	   {
	    		   String insertQuery = "INSERT INTO `teacher_register`(`ID`, `Name`, `Email`, `Password`) VALUES ('"+ID+"','"+Name+"','"+Email+"','"+Password+"')";
