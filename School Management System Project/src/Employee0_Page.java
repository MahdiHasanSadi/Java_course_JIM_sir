...
public class Employee0_Page extends JFrame{
	...
	JButton back_Btn1,teacherLogin_Btn,studentLogin_Btn,reg_Btn,min_Btn,close_Btn,back_Btn,next_Btn,employee1_Button,employee2_Button;
	
	public Employee0_Page() {
		setSize(500,400);
		setUndecorated(true);
		setResizable(false);
...
//        back_Btn1.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        employee1_Button = new JButton("Md Rahim Uddin"); 
        ...
        employee1_Label = new JLabel("Accounts Officer",JLabel.CENTER);
        ...
        employee2_Button = new JButton("Mst. Nujhat Rahman"); 
        employee2_Button.setBounds(145, 175, 220, 20);//335, 163, 110, 40//190, 163, 110, 40
        ...
        employee2_Label = new JLabel("Accounts Officer",JLabel.CENTER);
