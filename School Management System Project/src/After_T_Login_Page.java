...
public class After_T_Login_Page extends JFrame{
	JPanel title_Panel,input_Panel;
	JTextField email_Txt,pass_Txt;
	JLabel title_Label,aboutUs_Label;
	JButton Result,back_Btn1,student_Activity_Btn,academic_Council_Btn,administration_Btn,principal_Msg_Btn,min_Btn,close_Btn,back_Btn,back_To_Home_Btn;
	
	public After_T_Login_Page() { 
		setSize(500,400);
		setUndecorated(true);
		setResizable(false);
        ...
        Font font50 = new Font("Arial",Font.BOLD+Font.ITALIC,20);
...
// 			  new Admission2_Page();
        ...
        aboutUs_Label = new JLabel("Teacher",JLabel.CENTER);
        aboutUs_Label.setFont(font5);
        aboutUs_Label.setForeground(new Color(255,255,255));
        aboutUs_Label.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\t.png"));
        ...
        Result = new JButton("Insert Student Result");
        Result.setFont(font50);
//        Result.setForeground(new Color(255,255,255));
        Result.setBounds(100,90,300,40);//52,30,80,32
