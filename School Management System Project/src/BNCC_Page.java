...
public class BNCC_Page extends JFrame{
...
//       // Science_Lab_Label.setFont(font5);
//        //Science_Lab_Label.setForeground(new Color(255,255,255));
...
//        //Science_Lab_Label.getBackground().clearColorFilter();
//        Science_Lab_Label.setBackground(new Color(70,130,180));
//        //Science_Lab_Label.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\2.png"));
//        input_Panel.add(Science_Lab_Label);
        
        Science_Lab_Label1 = new JLabel("BNCC",JLabel.CENTER); 
        Science_Lab_Label1.setFont(font5);
        Science_Lab_Label1.setForeground(new Color(255,255,255));
        Science_Lab_Label1.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\BNCC.png"));
        Science_Lab_Label1.setBounds(0,10,500,35);//52,30,80,32
        //Science_Lab_Label.setIcon(new ImageIcon("D:\\ECLIPSE PROJECT FOLDER\\My_Project - Copy\\src\\Photos\\2.png"));
        input_Panel.add(Science_Lab_Label1);
        
        JTextArea txt = new JTextArea("Bangladesh National Cadet Corps (BNCC) of ABC School was\n"
        		                    + "established in 2005.There is a platoons of BNCC at present.\n"
        		                    + "\r\n"
        		                    + "ABC School Platoon includes the students of Class IV and V.\n"
        		                    + "Each platoon has 31 students in number.\r\n"
        		                    + "\r\n"
        		                    + "An Assistant teacher has been assigned with the duty of BNCC\n"
        		                    + "in the appointment of Professor Under Officer (PUO).");
