...
public class St_Result_Show2_Page extends JFrame implements ActionListener {
...
//   			  new St_Result_Show2_Page();
		...
		// *****************************Image**************************************//
		signIn_Label = new JLabel("Result2", JLabel.CENTER);// "Login",JLabel.CENTER
...
//          fetch_Btn.setBorder(emptyBorder);
//          fetch_Btn.setBackground(new Color(135,206,250));
	...
	public class Function {
		...
		public ResultSet find(String s) {
			try {
				...
				ps = con.prepareStatement("select * from student_register where id = ?");
				ps.setString(1, s);
				rs = ps.executeQuery();
			} catch (Exception ex) {
				JOptionPane.showMessageDialog(null, ex.getMessage());
