...
public class Notice1_Page extends JFrame{
	...
	JButton back_Btn1,next_Btn,min_Btn,close_Btn,back_Btn;
...
//        back_Btn1.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        JLabel notice1_Label = new JLabel("⦿ Admission:",JLabel.LEFT);
        notice1_Label.setBounds(30,50,500,30);
        notice1_Label.setFont(font4);
        input_Panel.add(notice1_Label);
        
        JTextArea notice1_Txt = new JTextArea("Event Date : 2021-12-01 to 2022-01-01\n"
        		                            + "\n"
        		                            + "Class Start : 2022-01-02\n"
        		                            + "\n"
        		                            + "Book Distribution : 2022-01-01\n"
        		                            + "\n"
        		                            + "Contact time : Office time\n"
        		                            + "\n");
        notice1_Txt.setBounds(50,100,500,130);
