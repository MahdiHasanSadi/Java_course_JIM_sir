...
public class Teacher2_Page extends JFrame{
	JPanel title_Panel,input_Panel,input_Panel2,input_Panel3;
	JTextField email_Txt,pass_Txt;
	JLabel title_Label,email_Label,password_Label,login_Label,teacher_Label,assistant3_Label1,assistant3_Label,assistant4_Label;
	JButton back_Btn1,teacherLogin_Btn,studentLogin_Btn,reg_Btn,min_Btn,close_Btn,back_Btn,next_Btn,assistant3_Button,assistant4_Button,previous_Btn;
	
	public Teacher2_Page() {
		setSize(500,400);
		setUndecorated(true);
		setResizable(false);
...
//        back_Btn1.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        assistant3_Button = new JButton("Sakur Majid"); 
        assistant3_Button.setBounds(165, 85, 180, 20);//335, 163, 110, 40//190, 163, 110, 40
        assistant3_Button.setFont(font6);
        assistant3_Button.setBorder(emptyBorder);
        assistant3_Button.setBackground(new Color(135,206,250));
        assistant3_Button.addActionListener(new ActionListener() {
        	@Override
            public void actionPerformed(ActionEvent e) {
                dispose();
				new T3();
        ...
        assistant3_Label = new JLabel("Assistant Teacher",JLabel.CENTER);
        assistant3_Label.setFont(font7);
        assistant3_Label.setForeground(new Color(255,255,255));
        assistant3_Label.setBounds(0,100,500,50);
        
        input_Panel.add(assistant3_Label);
        input_Panel.add(assistant3_Button);
        
        //*****************************************
        
        assistant4_Button = new JButton("Hossain Ahmad"); 
        assistant4_Button.setBounds(148, 175, 210, 20);//335, 163, 110, 40//190, 163, 110, 40
        assistant4_Button.setFont(font6);
        assistant4_Button.setBorder(emptyBorder);
        assistant4_Button.setBackground(new Color(135,206,250));
        assistant4_Button.addActionListener(new ActionListener() {
        	@Override
            public void actionPerformed(ActionEvent e) {
                dispose();
				new T4();
        ...
        assistant4_Label = new JLabel("Assistant Teacher",JLabel.CENTER);
        assistant4_Label.setFont(font7);
        assistant4_Label.setForeground(new Color(255,255,255));
        assistant4_Label.setBounds(0,190,500,50);
        
        input_Panel.add(assistant4_Label);
        input_Panel.add(assistant4_Button);
